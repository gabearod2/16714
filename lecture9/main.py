...
from .config import DEFAULT_CONFIG, Lecture9Config


DATA_OUTPUT_DIR = data_dir("lecture9")
...
POLICY_CASES = {
    "lqr": "LQRPolicy",
    "finite_horizon_lqr": "FiniteHorizonLQRPolicy",
...
def config_policy_module(cfg: PipelineConfig, **kwargs):
    ...
    case_name = kwargs.get("case_name", "linear_mpc")
...
def make_config(config: Lecture9Config = DEFAULT_CONFIG, **kwargs):
    defaults = {
...
def run(config: Lecture9Config = DEFAULT_CONFIG, **kwargs):
