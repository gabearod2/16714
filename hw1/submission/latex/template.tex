...
\solution{\input{soln/1.2}}

% \grading{\input{grad/1.2}}

{1.3 [8pt] Linearize the system at $[p_x^r,p_y^r,v^r,\theta^r]^T$. Write down the resulting dynamics.}

\solution{\input{soln/1.3}}

% \grading{\input{grad/1.3}}
...
\solution{\input{soln/1.4}}

% \grading{\input{grad/1.4}}
...
\solution{\input{soln/1.5}}

% \grading{\input{grad/1.5}}
